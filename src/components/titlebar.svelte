...
<div data-tauri-drag-region class="h-6 flex justify-between border-b bg-white border-slate-200">
  <div class="flex h-full mx-2 items-center gap-2">
    ...
    <span class="text-sm font-lobster select-none">Media Converter</span>
  </div>
  <div class="flex">
    <button 
      id= "minimizeBtn" 
