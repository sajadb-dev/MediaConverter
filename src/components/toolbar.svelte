...
<div class="h-14 px-4 flex items-center border-b border-slate-200 gap-6">
    <div class="flex gap-4">
        ...
        <button {...removetooltip.trigger} type="button" class="w-10 h-10 rounded flex items-center justify-center bg-slate-200 hover:bg-red-600 active:bg-red-700 hover:text-white active:text-white" aria-label="remove" onclick={removefile}>
